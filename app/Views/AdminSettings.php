        ...
        <div class="ibox ">
            ...
            <div style="border: 1px solid #99A3A4;">
                ...
                <div class="ibox-content">
                    ...
                    <a class="btn btn-outline btn-secondary" href="<?php echo base_url(); ?>/AdminChangeDetails" role="button"> <i class="fa fa-cog"></i> Change Details</a>

                    <a class="btn btn-outline btn-secondary" href="<?php echo base_url(); ?>/AdminUpdatePassword" role="button"> <i class="fa fa-cog"></i> Change Password</a>

                    <a class="btn btn-outline btn-secondary" href="<?php echo base_url(); ?>/AdminChangePicture" role="button"> <i class="fa fa-user"></i> Change Profile Picture</a>
                </div>
            ...
            <div style="border: 1px solid #3498DB;">
                ...
                <div class="ibox-content">
                    ...
                    <div>
                        ...
                        <p>
                            <a class="btn btn-success btn-outline" href="<?php echo base_url(); ?>/AdminController/addUser" role="button"> <i class="fa fa-plus "></i> Add Admin User(s)</a>
