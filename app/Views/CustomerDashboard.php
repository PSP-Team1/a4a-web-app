                                    ...
                                    <?php foreach ($venues as $venue) : ?>
                                       ...
                                       <tr class="footable-even" style="">
                                          ...
                                          <td class="footable-visible footable-last-column">
                                             ...
                                             <?php if ($progress != 100) { ?>
                                                <a class="btn btn-danger disabled" href="/AdminDashboard/ViewCompany/<?= $venue['id'] ?>" role="button">
                                                            ...
                                                            <div class="modal-body">
                                                               ...
                                                               <form method="post" action="<?php echo base_url(); ?>/CustomerDashboard/publishVenue">
                                                                  <div style="text-align:center;">
                                                                     ...
                                                                     <button type="submit" class="btn btn-primary btn-sm" style="display:block; width: 50%; margin: 0 auto;"><i class="fas fa-check"></i> Publish</button>
                                                                  </div>
                                                               </form>
                                                            </div>
