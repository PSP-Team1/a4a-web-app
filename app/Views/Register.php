   ...
   <div class="wrapper">
      ...
      <div class="login-container">
         <section class="Login-form">
            <div class="fusion-separator fusion-no-medium-visibility fusion-no-large-visibility fusion-full-width-sep" style="align-self: center;margin-left: auto;margin-right: auto;margin-top:40px;margin-bottom:10px;width:100%;">
            </div>
            <div class="form-content">
               ...
               <?php endif; ?>
               <form action="<?php echo base_url(); ?>/RegisterController/registerAuth" method="post" id="register-form" class="needs-validation">
                  <div class="form-group mb-3">
                     <input type="email" name="email" placeholder="Email" value="<?= set_value('email') ?>" class="form-control" required>
                  </div>
                  <div class="form-group mb-3">
                     <input type="text" name="contact" placeholder="Contact Name" value="<?= set_value('contact') ?>" class="form-control" required>
                  </div>
                  <div class="form-group mb-3">
                     <div class="input-group" style="display: flex;">
                        <input type="password" name="password" placeholder="Password" class="form-control" required onkeyup="isGood(this.value)">
                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" href="#accountModal" aria-label="Password requirements">
