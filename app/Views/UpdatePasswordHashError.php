               ...
               <div class="login-container">
                  <section class="Login-form">
                     <div class="form-content">
                        ...
                        <br>
                        <b>
                           <p style="color: maroon; text-align: center;">We are unable to verify your identity to reset your password. Please try again by requesting another password reset.</p>
                        </b>
                        <hr>
                        <div class="d-grid">
